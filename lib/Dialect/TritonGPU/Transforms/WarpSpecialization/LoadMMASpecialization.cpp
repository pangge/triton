...
LogicalResult PipelinedLoad::determineLiveRange(Block &container,
  ...
  auto regSinksRange = llvm::make_first_range(regSinks);
  auto shmemSinksRange = llvm::make_first_range(shmemSinks);
  userPartitions.insert(regSinksRange.begin(), regSinksRange.end());
  userPartitions.insert(shmemSinksRange.begin(), shmemSinksRange.end());
